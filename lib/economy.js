...
// Base rate: 100 LogCoin per hour before multipliers and upgrades.
const BASE_COINS_PER_HOUR = 100;

export function calculateCoins(logtimeHours, multiplier) {
  return Math.floor(logtimeHours * BASE_COINS_PER_HOUR * multiplier);
}
